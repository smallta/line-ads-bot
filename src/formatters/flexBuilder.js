export class FlexBuilder {
     ...
     */
    static buildOverviewFlex(metrics) {
     ...
     */
    static buildFatigueFlex(fatigued, accountName) {
     ...
     */
    static buildCampaignsFlex(campaigns, accountName) {
        const bubble = {
            type: 'bubble',
            size: 'mega',
            header: {
     ...
     */
    static buildHelpFlex(currentAccount) {
        const bubble = {
            type: 'bubble',
            size: 'mega',
            header: {
